...
A template notebook is provided as `asl_recognizer.ipynb`. The notebook is a combination tutorial and submission document.  Some of the codebase and some of the implementation will be external to the notebook. **Submission** section in the notebook have been implemented. 
